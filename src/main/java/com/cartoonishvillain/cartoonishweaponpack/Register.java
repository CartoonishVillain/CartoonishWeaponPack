...
public class Register {
    ...
    public static final RegistryObject<Item> COMICALLYLARGESPOON = ITEMS.register("comicallylargespoon", ()->new ComicallyLargeSpoon(WeaponMaterials.SPOON, 7, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
